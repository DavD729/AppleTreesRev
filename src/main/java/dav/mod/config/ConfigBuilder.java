...
public class ConfigBuilder {
	...
	private static void writeConfig() {
		...
		jsonConfig.addProperty("title", "Apple Trees Rev. Mod - Config File");
		
		JsonObject recipes = new JsonObject();
		recipes.addProperty("field_a", "Declare if you Want to Craft Golden Apple Saplings [true/false][default:false]");
		recipes.addProperty("craftGoldAppleSapling", false);
		craftGoldAppleSapling = false;
		recipes.addProperty("field_b", "Declare if you Want to Craft Notch Apples [true/false][default:false]");
