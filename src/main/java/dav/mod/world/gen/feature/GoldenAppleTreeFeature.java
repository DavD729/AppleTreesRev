...
public class GoldenAppleTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {

	private static final BlockState LOG = Blocks.OAK_LOG.getDefaultState();
	private static final BlockState LEAVES = Blocks.OAK_LEAVES.getDefaultState();
	private static final BlockState PLANT = BlockInit.GAPPLE_PLANT.getDefaultState();

	public GoldenAppleTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> configFactory) {
