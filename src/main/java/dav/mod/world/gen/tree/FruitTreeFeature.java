...
public class FruitTreeFeature extends AbstractBaseTree {
	...
	@Override
	protected void generateFruit(Set<BlockPos> changedBlocks, IWorldGenerationReader WorldIn, Random Rand, BlockPos Pos, MutableBoundingBox Box) {
	...
	private List<BlockPos> getValidLocations(IWorldGenerationReader WorldIn, BlockPos Pos){
	...
	private BlockState getFruitType(int type) {
		...
		return BlockList.GAPPLE_PLANT.getDefaultState();
	}
