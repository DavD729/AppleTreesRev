...
public class AppleTreeGen extends WorldGenAbstractTree{
    ...
    private static final IBlockState APPLE = BlockInit.APPLE_PLANT.getDefaultState().withProperty(BlockApplePlant.AGE, Integer.valueOf(0));
	...
	public boolean generate(World worldIn, Random rand, BlockPos position) {
		int i = rand.nextInt(2) + 5; //Tree Height
		int X = position.getX();
		int Y = position.getY();
		int Z = position.getZ();
		boolean flag = true;
